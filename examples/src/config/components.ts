...
export const COMPONENTS: ComponentMeta[] = [
  ...
  { id: 'hotspot', name: 'Hotspot', category: 'Overlay', description: '热点' },
  ...
  { id: 'wms-layer', name: 'WMSLayer', category: 'Layer', description: 'WMS 图层' },
  { id: 'wmts-layer', name: 'WMTSLayer', category: 'Layer', description: 'WMTS 图层' },
  { id: 'xyz-layer', name: 'XYZLayer', category: 'Layer', description: 'XYZ 图层' },
  { id: 'mvt-layer', name: 'MVTLayer', category: 'Layer', description: 'MVT 矢量瓦片图层' },
